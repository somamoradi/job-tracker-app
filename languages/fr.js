...
export default {
  ...
  app_description:
    "Suivi des Candidatures - Suivez vos candidatures facilement",
  app_copyright: "© 2025 Soma Moradi. Tous droits réservés.",
  ...
  archive: "Archiver l'Emploi",
  unarchive: "Désarchiver l'Emploi",
  ...
  clear_data_confirmation:
    "Cela supprimera définitivement toutes vos candidatures. Cette action ne peut pas être annulée. Êtes-vous sûr?",
  ...
  import_error:
    "Erreur lors de l'importation des données. Veuillez vérifier le format du fichier.",
  ...
  interview_notes_placeholder:
    "Détails de l'entretien, commentaires, prochaines étapes...",
};
