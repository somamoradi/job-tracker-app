...
export default {
  ...
  app_description:
    "Rastreador de Aplicaciones de Trabajo - Rastrea tus aplicaciones de trabajo fácilmente",
  app_copyright: "© 2025 Soma Moradi. Todos los derechos reservados.",
  ...
  archive: "Archivar Trabajo",
  unarchive: "Desarchivar Trabajo",
  ...
  delete_confirmation:
    "¿Estás seguro de que quieres eliminar esta aplicación de trabajo? Esta acción no se puede deshacer.",
  confirm_delete: "Eliminar",
  clear_data: "Borrar Todos los Datos",
  clear_data_confirmation:
    "Esto eliminará permanentemente todas tus aplicaciones de trabajo. Esta acción no se puede deshacer. ¿Estás seguro?",
  ...
  interview_notes_placeholder:
    "Detalles de la entrevista, comentarios, próximos pasos...",
};
